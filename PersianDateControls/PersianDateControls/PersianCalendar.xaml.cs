...
public partial class PersianCalendar : UserControl
{
    ...
    public static readonly DependencyProperty SelectedDateBackgroundProperty =
        DependencyProperty.Register("SelectedDateBackground", typeof(Brush), typeof(PersianCalendar),
            new UIPropertyMetadata(Brushes.Lavender));
    ...
    static PersianCalendar()
    {
        ...
        DisplayModeProperty =
            DependencyProperty.Register("DisplayMode", typeof(CalendarMode), typeof(PersianCalendar),
                displayModeMetaData);
        ...
        DisplayDateProperty =
            DependencyProperty.Register("DisplayDate", typeof(PersianDate.PersianDate), typeof(PersianCalendar),
                displayDateMetaData);
        ...
        SelectedDateProperty =
            DependencyProperty.Register("SelectedDate", typeof(PersianDate.PersianDate), typeof(PersianCalendar),
        ...
        DisplayDateStartProperty =
            DependencyProperty.Register("DisplayDateStart", typeof(PersianDate.PersianDate), typeof(PersianCalendar),
        ...
        DisplayDateEndProperty =
            DependencyProperty.Register("DisplayDateEnd", typeof(PersianDate.PersianDate), typeof(PersianCalendar),
    ...
    {
        get { return (PersianDate.PersianDate)this.GetValue(DisplayDateProperty); }
    ...
    void monthModeButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (displayDate.Year != buttonDate.Year || displayDate.Month != buttonDate.Month)
            this.SetCurrentValue(DisplayDateProperty,
                new PersianDate.PersianDate(buttonDate.Year, buttonDate.Month, 1));
    ...
    /// <param name="row">zero-based row number</param>
    /// <param name="column">zero-based column number</param>
    private static PersianDate.PersianDate monthModeRowColumnToDate(int row, int column,
        PersianDate.PersianDate displayDate)
    {
    ...
    private void setYearMode()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            {
                int month = j + i * 3 + 1;
                if (new PersianDate.PersianDate(DisplayDate.Year, month,
                        PersianDate.PersianDate.DaysInMonth(DisplayDate.Year, month)) >= DisplayDateStart &&
    ...
    private void previousButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            if (this.DisplayMode == CalendarMode.Month)
            {
                if (m == 1)
                    newDisplayDate =
                        new PersianDate.PersianDate(y - 1, 12, PersianDate.PersianDate.DaysInMonth(y - 1, 12));
                else
                    newDisplayDate =
                        new PersianDate.PersianDate(y, m - 1, PersianDate.PersianDate.DaysInMonth(y, m - 1));
            }
            else if (this.DisplayMode == CalendarMode.Year)
            {
            ...
            {
                newDisplayDate = new PersianDate.PersianDate(y - y % 10 - 1, 12,
                    PersianDate.PersianDate.DaysInMonth(y - y % 10 - 1, 12));
            }
